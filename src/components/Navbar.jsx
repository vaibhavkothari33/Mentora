...
//   return (
//     <nav className={`${darkMode ? 'bg-gray-900/90' : 'bg-white/90'} backdrop-blur-md shadow-lg sticky top-0 z-50 transition-all duration-300 border-b ${darkMode ? 'border-gray-800' : 'border-gray-200'} opacity:0`}>
...
import { useState } from 'react';
import { Link, useLocation } from 'react-router-dom';
import { FaGraduationCap, FaMoon, FaSun, FaBars, FaTimes, FaSignOutAlt } from 'react-icons/fa';
import WalletConnect from './WalletConnect';
import { useTheme } from '../context/ThemeContext';
